<?php
	...
	$sql = "SELECT * FROM mahasiswa ORDER BY waktu_aktif DESC";
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<a href="input_mhs.php" id="mahasiswa" name="mahasiswa" value="mahasiswa" method="POST"><div class="btn btn-primary">Input Data</div></a>
				<table class="table table-bordered"> 
					<thead>
						<tr>
							...
							<th class="table-header" wnimmhsth="20%">PASSWORD</th>

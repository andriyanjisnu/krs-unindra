<?php
	...
	$sql = "SELECT * FROM mahasiswa WHERE fakultas='FIIPS'";
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Mahasiswa <span class="fa fa-chevron-down"></span></a>
					<ul class="nav child_menu">
                      <li><a href="modul.php?modul=fakultasall">Semua Fakultas</a></li>
                      <li><a href="modul.php?modul=fiips">FIIPS</a></li>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>FAKULTAS ILMU PENDIDIKAN DAN PENGETAHUAN SOSIAL</h3>
              </div>
			  ...
			  <a href="input_mhs_fiips.php" id="mahasiswa" name="mahasiswa" value="mahasiswa" method="POST"><div class="btn btn-primary">Input Data</div></a>

<?php
	...
	$sql = "SELECT * FROM mahasiswa WHERE fakultas='FBS'";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>FAKULTAS BAHASA DAN SENI</h3>
              </div>
              ...
              <div class="title_right">
			   ...
			   <a href="input_mhs_fbs.php" id="mahasiswa" name="mahasiswa" value="mahasiswa" method="POST"><div class="btn btn-primary">Input Data</div></a>

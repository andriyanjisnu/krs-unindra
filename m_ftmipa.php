<?php
	...
	$sql = "SELECT * FROM mahasiswa WHERE fakultas='FTMIPA'";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>FAKULTAS TEKNIK, MATEMATIKA DAN IPA</h3>
              </div>
              ...
              <div class="title_right">
			   ...
			   <a href="input_mhs_ftmipa.php" id="mahasiswa" name="mahasiswa" value="mahasiswa" method="POST"><div class="btn btn-primary">Input Data</div></a>
